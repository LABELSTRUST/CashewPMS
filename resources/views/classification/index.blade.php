                                ...
                                <table class="table table-hover table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $classification->created_at)->format('d/m/Y') }}
                                          </td>
                                          <td>
                                            {{ $classification->getUnskinning?->unskinning_batch }}
                                          </td>
                                          <td>
                                            {{ $classification->weight }}
                                          </td>
                                          <td>
                                            {{ $classification->getGrade->designation }}
                                          </td>
                                          <td>
                                              @if ($classification->transfert)
                                                  <button class="btn btn-success">Transférer</button>
                                              @else
                                                <a class="btn btn-info"  href="{{route('classification.transfert',[$classification->id])}} ">Transférer</a>
