...
<div class="row">
  ...
  <div class="col-lg-10" style="margin-left: 2%;">
      <div class="row d-flex justify-content-between">
        ...
        <div class="mb-2">
            <a href="{{ route('classification.index') }}" class="btn btn-lg btn-outline-info">Liste</a>
        </div>
      </div>
      <div class="row">
              ...
              <div class="">
                      ...
                      <tbody>
                          ...
                          @foreach ($classifications as $classification)
                            <tr>
                              ...
                              <td >
                                  <a class="btn icon-btn btn-outline-info mr-2" href="{{ route('classification.details',[$classification->id]) }} "><span class="feather icon-eye"></span></a>{{--  --}}
                              </td>
                            </tr>
                          @endforeach
                      </tbody>
                ...
                <div class="row mt-2">
                  <div class="col-lg-12 col-12">
                    <form action="{{ route('classification.registerRapport') }} " method="POST" enctype="multipart/form-data">
                      @csrf
