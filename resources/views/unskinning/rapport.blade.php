...
<div class="row">
  ...
  <div class="col-lg-10" style="margin-left: 2%;">
      <div class="row d-flex justify-content-between">
        ...
        <div class="mb-2">
            <a href="{{ route('unskinning.index') }}" class="btn btn-lg btn-outline-info">Liste</a>
        </div>
      </div>
      <div class="row">
              ...
              <div class="">
                  ...
                  <table class="table table-bordered"  width="100%" cellspacing="0">
                      ...
                      <tbody>
                          ...
                          @foreach ($unskinnings as $unskinning)
                            <tr>
                              <td>{{$unskinning->id}}</td>
                              <td>{{ \Carbon\Carbon::parse($unskinning->created_at)->format('d/m/Y') }}</td>
                              <td>{{$unskinning->unskinning_batch}}</td>
                              <td>{{$unskinning->weight}}</td>
                              <td >
                                  <a class="btn icon-btn btn-outline-info mr-2" href="{{ route('unskinning.detail',[$unskinning->id]) }} "><span class="feather icon-eye"></span></a>{{--  --}}
                              </td>
                            </tr>
                          @endforeach
                      </tbody>
                ...
                <div class="row mt-2">
                  <div class="col-lg-12 col-12">
                    <form action="{{ route('unskinning.registerRapport') }} " method="POST" enctype="multipart/form-data">
                      @csrf
