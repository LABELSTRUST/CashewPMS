                            ...
                            <div class="table-responsive   col-md-6-sm-6-xs-6">
                                <table class="table table-bordered "  width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                      ...
                                      @if (isset($unskinning->weight_cj))
                                        <tr>
                                          <td>Poids avant dépelliculage manuel</td>
                                          <td>{{$unskinning->weight_cj}}  </td>
                                        </tr>    
                                      @endif
                                      <tr>
                                        <td>Poids </td>
                                      ...
                                      <tr>
                                        <td>Séquence</td>
                                        <td>{{str_pad($unskinning->getSequence->code, 2, '0', STR_PAD_LEFT)}}</td>
                                      </tr>
                                    </tbody>
