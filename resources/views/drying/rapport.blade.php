...
<div class="row">
  ...
  <div class="col-lg-10" style="margin-left: 2%;">
      <div class="row d-flex justify-content-between">
        ...
        <div class="mb-2">
            <a href="{{ route('drying.listeDraying') }}" class="btn btn-lg btn-outline-info">Liste</a>
        </div>
      </div>
      <div class="row">
              ...
              <div class="">
                      ...
                      <tbody>
                          ...
                          @foreach ($dryings as $drying)
                            <tr>
                              ...
                              <td >
                                  <a class="btn icon-btn btn-outline-info mr-2" href="{{route('drying.details',[$drying->id])}} {{-- --}} "><span class="feather icon-eye"></span></a>
                              </td>
                            </tr>
                          @endforeach
                      </tbody>
                ...
                <div class="row mt-2">
                  <div class="col-lg-12 col-12">
                    <form action="{{ route('drying.registerRapport')}}" method="POST" enctype="multipart/form-data">
                      @csrf
