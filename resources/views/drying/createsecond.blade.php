...
<div class="row">
  <div class="col-lg-10" >
    <div class="row d-flex justify-content-between" style="">
      ...
      <div class="mb-2">
        <a class="btn btn-info" href="{{route('drying.index')}}">Liste</a>
      </div>
  ...
  <div class="container">
    ...
    <div class="card card-outline card-primary">
      <div class="card-header text-center">
        <h4 class="card-title"> Séchage 2!</h4>
      </div>
      <div class="card-body">
        
        <form class="user"action="{{ route('drying.storesecond') }}" id="form-data" method="POST"  enctype="multipart/form-data">
          @csrf
          
            <div class="form-row">
              <div class="form-group col-md-3" id="nbr_sacs">
                <label for="">Température initiale</label>{{-- {{ isset($origin_prod ) ? $origin_prod->date_recep : '' }} --}}
                  <input type="number" min="0" name="initial_temp" value="{{ $drying->finale_temp }}" class="form-control" id="initial_temp" placeholder="Température initiale" >
              </div>
              
                <input   type="text" hidden name="first_drying_id" value="{{ $drying->id }}">
              ...
              <div class="form-group col-md-3">
                <label for="">Poids avant séchage </label>
                  <input  type="text" name="weigth_before" class="form-control " id="weigth_before" placeholder="Poids avant séchage" value="{{ $drying->weigth_after }}">
              </div>
            </div>
...
/* $("#start_time").change(function(){
  ...
  var heureDate = new Date('2000-01-01T' + heureDepart + ':00+01:00');
