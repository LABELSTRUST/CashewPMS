         ...
         <div class="container-fluid flex-grow-1 container-p-ycard shadow mb-4 pmanager">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>ID Target</th>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('sequence.edit',[$sequence->id]) }}">Modifier</a>
                                                    <a class="dropdown-item" onclick="return  confirm('Voulez vous supprimer cette séquence?')" href="{{ route('sequence.destroy',[$sequence->id]) }}">Supprimer</a>
                                                    <a class="dropdown-item" href="{{ route('assigner.assignerposte',[$sequence->id]) }}">Assigner</a>
                                                </div>
                                            </div>
                                        </td>
