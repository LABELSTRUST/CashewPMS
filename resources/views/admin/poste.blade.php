                                        ...
                                        <td style=" width: 25%;">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{ route('poste.operateors', [$poste->id])  }}">Agents par poste</a>
                                                        <a class="dropdown-item" href="{{ route('poste.edit',[$poste->id] ) }}">Modifier</a>
                                                        <a class="dropdown-item" onclick="return  confirm('Voulez vous supprimer cette ligne?')" href="{{ route('poste.destroy',[$poste->id]) }}">Supprimer</a>
                                                    </div>
                                                </div>
                                        </td>
                                        <!--td>$320,800</td-->
