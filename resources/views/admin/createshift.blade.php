...
<div class="row">
  ...
  <div class="row" style="margin-bottom: 20px;">
            <div class="col-lg-6">
                <a href="{{ route('shift.index') }}" class="btn btn-xl btn-outline-primary">Retour</a>
            </div>
         </div>
  </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                      <label for="">Heure d'ouverture</label>
                                        <input type="time" name="time_open" class="form-control " id="code"
                                            placeholder="Code">
                                    </div>
                                    <div class="col-sm-6">
                                      <label for="">Heure de fermeture</label>
                                        <input type="time" name="time_close" class="form-control " id="exampleLastName"
                                            placeholder="Name">
                                    </div>
                                </div>
                                <div class="form-group">
                                  <label for="">Name</label>
                                  <input type="text" name="title" class="form-control " id="exampleLastName"
                                            placeholder="Name">
                                </div>
