                ...
                <div class="container-fluid flex-grow-1  shadow mb-4 pmanager">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table table-bordered mytable" id="dataTable" width="100%"
                                cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" id="assigner"
                                                            href="{{ route('assigner.assignerposte', [$sequence->id]) }}">Assigner</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('assigner.poste_operateur', [$sequence->id]) }}">Opérateurs
                                                            assignés</a>
                                                    </div>
                                                </div>
                                            </td>
