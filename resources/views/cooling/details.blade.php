                            ...
                            <div class="table-responsive   col-md-6-sm-6-xs-6">
                                <table class="table table-bordered "  width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td>Poids net après cuisson</td>
                                        <td>{{$cooling->weight_after_cook}}  </td>
                                      </tr>
                                      <tr>
                                        <td>Poids net après refroidissement</td>
                                      ...
                                      <tr>
                                        <td>Température  au début</td>
                                        <td>{{$cooling->start_temp}} </td>
                                      </tr>
                                      <tr>
                                        <td>Température après </td>
                                        <td>{{$cooling->end_temp}}  </td>
                                      </tr>
                                      <tr>
                                        <td>Séquence</td>
                                        <td>{{str_pad($cooling->getSequence->code, 2, '0', STR_PAD_LEFT)}}</td>
                                      </tr>
                                    </tbody>
