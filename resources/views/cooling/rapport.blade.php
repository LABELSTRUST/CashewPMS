...
<div class="col-lg-10" style="margin-left: 2%;">
         <div class="row d-flex justify-content-between">
            ...
            <div class="mb-2">
                <a href="{{ route('cooling.index') }}" class="btn btn-lg btn-outline-info">Liste</a>
            </div>
         </div>
         <div class="row">
                        ...
                        <div class="card-body">
                          <div class="">
                            ...
                            <div class=" row table-responsive">
                              <table class="table table-bordered"  width="100%" cellspacing="0">
                                  <thead>
                                      <tr>
                                          ...
                                          <th>Date</th>
                                          <th>Lot PMS</th>
                                          <th>Poids net après refroidissement</th>
                                          <th>Action</th>
                                          <!--th>Salary</th-->
                                      </tr>
                                  </thead>
                                  ...
                                  <tbody>
                                      ...
                                      @foreach ($coolings as $cooling)
                                        <tr>
                                          <td>{{$cooling->id}}</td>
                                          <td>{{ \Carbon\Carbon::parse($cooling->created_at)->format('d/m/Y') }}</td>
                                          <td>{{$cooling->getFrag->getCalibrage->id_lot_calibre}}</td>
                                          <td>{{$cooling->weight_after_cooling}}</td>
                                          <td >
                                              <a class="btn icon-btn btn-outline-info mr-2" href="{{route('cooling.coolingdetails',[$cooling->id])}} "><span class="feather icon-eye"></span></a>
                                          </td>
                                        </tr>
                                      @endforeach
                                  </tbody>
                              ...
                              {{ $coolings->links('pagination::bootstrap-4') }}
                              
                            </div>
                            <div class="row mt-2">
                              <div class="col-lg-12 col-12">
                                <form action="{{ route('cooling.registerRapport')}}" method="POST" enctype="multipart/form-data">
                                  @csrf
