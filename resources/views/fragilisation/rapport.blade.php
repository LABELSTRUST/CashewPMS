...
<div class="col-lg-10" style="margin-left: 2%;">
         <div class="row d-flex justify-content-between">
            ...
            <div class="mb-2">
                <a href="{{ route('cuiseur.create') }}" class="btn btn-lg btn-outline-info">Cuiseur</a>
            </div> --}}
         </div>
         <div class="row">
                          ...
                          <div class="">
                            ...
                            <div class="row d-flex">
                              <div class="col-6">
                                ...
                                <div class="d-flex">
                                  ...
                                  <div class="col-6">
                                    <h5>{{ \Carbon\Carbon::parse($sequence->date_start)->format('d/m/Y') }}</h5>
                                  </div>
                                </div>
                                <div class="d-flex">
                                  ...
                                  <tbody>
                                      ...
                                      @foreach ($fragilisations as $fragilisation)
                                        <tr>
                                          ...
                                          <td >
                                              <a class="btn icon-btn btn-outline-info mr-2" href="{{route('fragilisation.show',[$fragilisation->id])}} "><span class="feather icon-eye"></span></a>
                                          </td>
                                        </tr>
                                      @endforeach
                                  </tbody>
                            ...
                            <div class="row mt-2">
                              <div class="col-lg-12 col-12">
                                <form action="{{ route('fragilisation.registerrapport')}}" method="POST" enctype="multipart/form-data">
                                  @csrf
