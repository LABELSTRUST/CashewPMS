                          ...
                          <form id="search-form" class="mb-3">
                            ...
                            <div class="form-row">
                              <div class="form-group  col-4 d-flex ">
                                <input type="text" class="form-control mr-3" placeholder="Batch ID:" name="batch_id" id="batch_id">
                                <input type="text" class="form-control" placeholder="Poids" name="weight" id="weight">
                              </div>
...
$(document).ready(function() {
  $('#search-form').submit(function(e) {
      ...
      $.ajax({
          url: "{{ route('calibrage.searchissue') }}",
          type: "POST",
          data: formData,
          dataType: "json",
