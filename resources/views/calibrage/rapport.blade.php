                          ...
                          <div class="">
                            ...
                            <div class=" row table-responsive">
                              <table class="table table-bordered"  width="100%" cellspacing="0">
                                  ...
                                  <tbody>
                                      ...
                                      @foreach ($calibrages as $calibrage)
                                        <tr>
                                          <td>{{$calibrage->id}}</td>
                                          ...
                                          <td>{{$calibrage->initial_caliber_weight}}</td>
                                          <td >
                                              <a class="btn icon-btn btn-outline-info mr-2" href="{{route('calibrage.calibragedetail',[$calibrage->id])}} "><span class="feather icon-eye"></span></a>
                                          </td>
                                        </tr>
                                      @endforeach
                                  </tbody>
                            ...
                            <div class="row mt-2">
                              <div class="col-lg-12 col-12">
                                <form action="{{ route('calibrage.registerRapport')}}" method="POST" enctype="multipart/form-data">
                                  @csrf
