...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('current_rapport_sechages', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('rapport_id')->references('id')->on('rapport_sechages')->onDelete('set null');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('current_rapport_sechages');
    }
};
